...
![后台分组管理.png](/后台分组管理.png)

## 账号管理
支持用户新增、删除、编辑，用户密码修改、用户冻结、账号失效时间
![后台账号管理.png](/后台账号管理.png)

## 身份源设置
支持多个账号来源，可以自建账号，可以从第三方同步等
![后台身份源设置.png](/后台身份源设置.png)
...
![后台vpn访问策略.png](/后台vpn访问策略.png)

## 在线会话
支持实时查看在线用户连接情况，可以强制用户下线
![后台vpn在线会话.png](/后台vpn在线会话.png)

## 分配地址
查看每个账号各个终端分配的ip情况，支持删除，重新分配
![后台vpn分配地址.png](/后台vpn分配地址.png)
...
## 设备列表
展示所有用户登录的设备列表详情
![后台终端设备列表.png](/后台终端设备列表.png)

## 授权记录
展示所有用户授权的设备，可以自动或者手动授权设备，同时也可以禁用相应设备
![后台授权记录.png](/后台授权记录.png)
...
- 2、访问日志:用户访问日志
![后台终端vpn日志.png](/后台终端vpn日志.png)
## 终端登录日志
终端设备登录日志详情
![后台终端登录日志.png](/后台终端登录日志.png)

## 后台系统日志
- 1、登录日志：记录后台系统登录日志
- 2、操作日志：记录后台系统操作日志
![后台系统日志.png](/后台系统日志.png)
